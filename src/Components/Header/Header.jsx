  ...
  const links = (
    <>
      <nav className="flex">
        ...
        <NavLink to="/plants">
          <li className="m-2 text-[18px] font-semibold">Plants</li>
        </NavLink>
        ...
        <div className="navbar-start ">
          ...
          <NavLink to="/">
            <div className="btn btn-ghost text-xl">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#106927] to-[#39a15c] text-2xl font-semibold">
                GreenNest
              </span>
            </div>
          </NavLink>
